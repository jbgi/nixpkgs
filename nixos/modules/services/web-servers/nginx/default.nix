          ...
          optionalString
            ...
            ''
              location ^~ /.well-known/acme-challenge/ {
                ...
                ''}
                ${optionalString (vhost.acmeRoot != null && vhost.acmeS3BucketHost == null) "root ${vhost.acmeRoot};"}
                auth_basic off;
              }
              ${optionalString (vhost.acmeFallbackHost != null && vhost.acmeS3BucketHost == null) ''
